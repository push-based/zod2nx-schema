...
More on this subject as well as all the testing strategy principles can be found on the GitHub [wiki](https://github.com/push-based/cli/wiki/Testing-Strategy#mocking).
