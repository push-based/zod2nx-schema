...
import { cpCliVersion, cpNxPluginVersion } from '../../internal/versions.js';
...
function checkDependenciesInstalled(host: Tree) {
  ...
  devDependencies['@push-based/zod2nx-schema'] = cpCliVersion;
...
function updateNxJsonConfig(tree: Tree) {
  ...
  nxJson.targetDefaults[DEFAULT_TARGET_NAME] = {
